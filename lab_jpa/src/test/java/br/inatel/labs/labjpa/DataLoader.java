...
//	@Test
	void load() {
		// produto
		Produto p1 = new Produto("Camisa Brasil");
		Produto p2 = new Produto("Camisa Argentina");
		Produto p3 = new Produto("Camisa França");
		Produto p4 = new Produto("Camisa Alemanha");
		Produto p5 = new Produto("Camisa Espanha");
		...
		// fornecedor
		Fornecedor f1 = new Fornecedor("Xu Lei Imports");
		Fornecedor f2 = new Fornecedor("Sports Center");
